...
export default class ColotteryApiWrapper {
  ...
  public static async getPastDraws(
    ...
    ColotteryApiWrapper.past_draw_endpoint = ColotteryApiWrapper.past_draw_endpoint
  ...
  public static async getAllPastDraws(): Promise<Array<ColotteryN.DrawOutcomeT>> {
...
console.log(await ColotteryApiWrapper.getMostRecentDraw())
